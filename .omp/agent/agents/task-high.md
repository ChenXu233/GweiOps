---
name: task-high
description: General-purpose subagent with full capabilities for delegated multi-step tasks，but model is more powerful and can handle more complex tasks
spawns: "*"
model: 
  - glm-5.2-free-train
---
